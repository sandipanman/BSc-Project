...
def main(NSteps,production,deltat,temp,DumpFreq,epsilon,DIM,N,Rcutoff,pos,vel,acc):
    ...
    return ene_kin_aver,ene_pot_aver, temperature, pressure, dist_sq/N,pos
...
for temp in temp_list :
    ...
    ene_kin_aver,ene_pot_aver, temperature, pressure,dist_meansq,pos = main(NSteps,1,deltat,temp,DumpFreq,epsilon,DIM,N,Rcutoff,pos,vel,acc)
